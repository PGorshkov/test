...
INSERT INTO "new_Game" ("goalMin", "id", "leagueId", "leagueName", "matchAwayTeamId", "matchAwayTeamName", "matchDate", "matchHomeTeamId", "matchHomeTeamName", "matchId", "matchTime", "result", "sendChat", "sendMin") SELECT "goalMin", "id", "leagueId", "leagueName", "matchAwayTeamId", "matchAwayTeamName", "matchDate", "matchHomeTeamId", "matchHomeTeamName", "matchId", "matchTime", "result", "sendChat", "sendMin" FROM "Game";
DROP TABLE "Game";
